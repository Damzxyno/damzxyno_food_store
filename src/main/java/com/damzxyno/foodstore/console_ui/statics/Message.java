...
public final class Message {
    ...
    public static final String DELIMETER_III = "####################################";
    public static final String DELIMETER_IV = "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$";
    public static final String DELIMETER_V = "-------------------------";
    ...
    public static final String PAGE_SIZE_EXCEEDED = "Page size exceed!";
    ...
    public static final String ACCOUNT_LOGIN_SUCCESSFUL = "=====Account login successful!===== \n =========================";
